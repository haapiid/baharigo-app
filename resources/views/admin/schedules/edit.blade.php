<x-admin-layout>
    <x-slot name="title">Edit Jadwal Travel</x-slot>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-8 py-6 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">Edit Jadwal Travel</h2>
                        <p class="text-gray-500 text-sm mt-0.5">Perbarui informasi jadwal travel</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('admin.schedules.update', $schedule->id) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="destination" name="destination" value="{{ $schedule->destination }}" required class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 transition-all" placeholder="Contoh: Jakarta - Bandung">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <div class="relative">
                            <input type="datetime-local" id="departure_at" name="departure_at" value="{{ \Carbon\Carbon::parse($schedule->departure_at)->format('Y-m-d\TH:i') }}" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="quota" name="quota" value="{{ $schedule->quota }}" required min="1" max="100" class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="price" name="price" value="{{ $schedule->price }}" required min="10000" step="1000" class="block w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                    </div>
                </div>
